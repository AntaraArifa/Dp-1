...
const AssessmentCreator = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const newAssessment = { ...formData, id: Date.now() }; // Add ID
            localStorage.setItem("assessments", JSON.stringify([...existing, newAssessment]));

            toast.success("Assessment created successfully!");
            navigate("/admin/AssessmentDashboard");
        } catch (error) {
