...
const JobDescription = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <h3 className='border-b-2 border-b-gray-300 font-bold py-4'>Job Description</h3>
            <div className='my-4'>
              ...
              <h3 className='font-bold my-1'>Experience:<span className='pl-4 font-normal text-gray-800'>{singleJob?.experience}</span></h3>
              <h3 className='font-bold my-1'>Salary:<span className='pl-4 font-normal text-gray-800'>{singleJob?.salary}</span></h3>
              <h3 className='font-bold my-1'>Total Applicant:<span className='pl-4 font-normal text-gray-800'>{singleJob?.applications?.length}</span></h3>
